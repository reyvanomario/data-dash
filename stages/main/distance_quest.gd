...
func initialize():
	...
	quest_box_instance.quest_progress_label.text = "0/1000"
...
func check_distance(new_distance: float):
	quest_box_instance.quest_progress_label.text = str(floori(new_distance - start_distance)) + "/1000"

	if (new_distance - start_distance) >= 1000:
		...
		quest_box_instance.quest_progress_label.text = "1000/1000"
